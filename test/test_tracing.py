...
class TestSpan:
    def test_span_defaults(self):
        span = Span(name="test", trace_id="t1", span_id="s1", start=100.0)
    ...
    def test_span_is_slow(self):
        span = Span(name="slow", trace_id="t1", span_id="s1", start=100.0, status="slow")
        assert span.is_slow is True

    def test_span_not_slow(self):
        span = Span(name="ok", trace_id="t1", span_id="s1", start=100.0, status="ok")
        assert span.is_slow is False

    def test_span_error(self):
        span = Span(name="err", trace_id="t1", span_id="s1", start=100.0, status="error")
        assert span.is_slow is False
